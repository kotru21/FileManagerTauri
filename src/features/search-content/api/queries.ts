...
export const searchKeys = {
  all: ["search"] as const,
  byName: (path: string, query: string) =>
    [...searchKeys.all, "name", path, query] as const,
  byContent: (path: string, query: string) =>
    [...searchKeys.all, "content", path, query] as const,
  full: (options: SearchOptions) =>
    [...searchKeys.all, "full", options] as const,
};
