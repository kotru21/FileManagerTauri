...
export function registerSidebar(ref: React.RefObject<PanelImperativeHandle | null> | null) {
  sidebarRef = ref
}

export function registerPreview(ref: React.RefObject<PanelImperativeHandle | null> | null) {
  _previewRef = ref
}
